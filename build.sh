...
echo "==> mb_compositor_widget_smoke (Compositor milestone D2b-2: live InitializeCompositing + frame-sink hook)"
( cd "$TREE/$OUT" && DYLD_LIBRARY_PATH="$PWD" ./mb_compositor_widget_smoke )
