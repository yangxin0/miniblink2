...
[ -f "$DIST/include/miniblink2/webview.h" ] || {
...
$LIB_LINES- \`include/miniblink2/webview.h\` — the embedder core (mb* C API); \`automation.h\` — the automation kit (waits/shots/scraping; pumps).
